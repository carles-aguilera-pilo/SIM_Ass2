...
Once we have identified and estimated the best model, and after removing the most influential observations, we proceed to carry out the final validation phase. In this step, we evaluate how well the model is able to predict using the test dataset that we previously set aside.
