...
# AQUI TENIM UN VALUE OF 0.25 APROXIMADAMENT, UN VALOR GRAN.
...
mdl1 <- glm(target~city_development_index+experience, family = binomial, data = df)
summary(mdl1)

mdl2 <- glm(target~city_development_index+experience+training_hours, family = binomial, data = df)
summary(mdl2)

mdl3 <- glm(target~city_development_index+experience+training_hours+last_new_job, family = binomial, data = df)
summary(mdl3)


anova(mdl0, mdl1, test = "Chisq") # millor el model 1
anova(mdl1, mdl2, test = "Chisq") # millor el model 2
anova(mdl2, mdl3, test = "Chisq") # millor el model 2
AIC(mdl2, mdl3)                   # millor el model 2
# millor el model 2.
```

# SI ARA AFEGISSIM CATEGORIQUES
